...
### Definición: 
## Los diccionarios en Python son como la guía telefónica del barrio: guardás cosas en formato clave: valor. La clave sería el nombre del vecino y el valor el teléfono.
## Son súper prácticos porque podés encontrar lo que buscás al toque con la clave, y encima, podés agregar, cambiar o borrar datos sin vueltas. 
